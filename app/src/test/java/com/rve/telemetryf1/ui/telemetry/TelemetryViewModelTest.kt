...
class TelemetryViewModelTest {
    ...
    fun uiState_initiallyLoading() = runTest {
        val viewModel = TelemetryViewModel(FakeTelemetryRepository())
        assertEquals(viewModel.uiState.first(), TelemetryUiState.Loading)
    }
...
private class FakeTelemetryRepository : TelemetryRepository {
    ...
    override val telemetrys: Flow<List<String>>
